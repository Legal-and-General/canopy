...
<div class="lg-sb-preview">
  {/* <Story id="components-blockquote-examples--quote" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story id="components-blockquote-examples--quote" />
</div>
