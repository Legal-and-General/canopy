...
<Source id="components-footer-examples--standard-footer" />
...
<Source id="components-footer-examples--co-branded-footer" />

### Compact

A compact layout can be achieved by using the below structure:

<Source id="components-footer-examples--compact-footer" />
