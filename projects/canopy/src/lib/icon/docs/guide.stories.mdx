...
<Meta title="Foundation/UI icon/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
Import the icon module into your module:
...
- [Brand icons](./?path=/docs/components-brand-icon--standard-brand-icons)
