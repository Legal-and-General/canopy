...
This card example demonstrates different variants (default, promo, navigation) with media support. Use the controls to switch between image and brand icon media, and adjust the layout orientation.
