...
The standard card example includes controls for `default`, `promo`, and `interactive` variants.

<Source of={CardStories.DefaultCard} />
...
<Source of={CardStories.ThreeImages} />
