...
<Meta title="Helpers/Directives/Skeleton loading/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
## Usage
Import the skeleton module in your application:
