...
import * as FilterMultipleStories from './filter-multiple.stories';
import { CustomBadge } from 'storybook-addon-tag-badges/manager-helpers'

<Meta title="Components/Filter buttons/Guide" tags={['pending']}/>
...
<Source of={FilterSingleStories.FilterButtons} />
...
<Source of={FilterMultipleStories.FilterMultipleButtons} />
...
| `ariaDescribedBy` | HTML ID for the corresponding element that describes the filters, if not provided it will use the hint field where appropriate | `string`        | `null`                                      | No       |
...
|-----------|--------------------------------------------------------------------|-----------|-------------------------------|----------|
| `id`      | HTML ID attribute, auto generated if not provided                  | `string`  | auto-generated | No       |
| `name`    | HTML Name attribute, auto generated if not provided                | `string`  | auto-generated | No       |
