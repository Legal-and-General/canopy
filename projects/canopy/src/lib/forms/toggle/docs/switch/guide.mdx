...
<Meta title="Components/Forms/Switch/Guide" tags={['awaiting-deprecation']} />

# Switch

<CustomBadge
  text="Awaiting deprecation"
  style={{ backgroundColor: '#ffb600', borderColor: '#ffb600', color: '#1d1d1b' }}
/>

<p class="standfirst">
  A switch is used to quickly alternate between two possible states with immediate effect,
  usually turning a setting on or off.
</p>
