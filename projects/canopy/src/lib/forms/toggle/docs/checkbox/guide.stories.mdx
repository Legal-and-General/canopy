...
<Meta title="Components/Form/Checkbox/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
The checkbox component is a variant of the toggle component. Import the toggle module in your module:
...
The checkbox group component is a container which displays the label with an optional hint and should contain two or more toggle components. The hint component may be used to provide extra context to the user. Import the toggle and checkbox group modules in your module:
...
Where a definitive positive or negative response is required from the user then maybe the Radio button component would be more suitable.

- [Radio buttons](./?path=/docs/components-form-radio--radio)
