...
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|:----------------------------------:|:--------:|
| `dateId`          | HTML ID attribute for the date input, auto generated if not provided                                                                           | `string`  | auto-generated  |    No    |
| `monthId`         | HTML ID attribute for the month input, auto generated if not provided                                                                          | `string`  | auto-generated |    No    |
| `yearId`          | HTML ID attribute for the year input, auto generated if not provided                                                                           | `string`  | auto-generated  |    No    |
