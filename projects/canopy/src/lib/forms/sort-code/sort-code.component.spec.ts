...
describe('SortCodeComponent', () => {
  ...
  let sorCodeDebugElement: DebugElement;
  ...
  beforeEach(() => {
    ...
    sorCodeDebugElement = fixture.debugElement.query(By.directive(LgSortCodeComponent));
    sortCodeFieldInstance = sorCodeDebugElement.componentInstance;
