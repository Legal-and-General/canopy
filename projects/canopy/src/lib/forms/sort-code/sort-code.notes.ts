...
| \`\`firstId\`\` | HTML ID attribute for the first number input, auto generated if not provided | string | \`\`lg-input-date-\${nextUniqueId++}\`\` | No |
| \`\`secondId\`\` | HTML ID attribute for the second number input, auto generated if not provided | string | \`\`lg-input-month-\${nextUniqueId++}\`\` | No |
| \`\`thirdId\`\` | HTML ID attribute for the third number input, auto generated if not provided | string | \`\`lg-input-year-\${nextUniqueId++}\`\` | No |
