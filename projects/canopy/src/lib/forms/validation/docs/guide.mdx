...
|------------|----------------------------------------------------------------------|-----------|---------|----------|
| `status`  | The status of the validation: `info`, `warning`, `error`, `success` | `string`  | `error` | No       |
| `statusTheme`  | The status theme of the validation: `neutral`, `neutral-inverse`, `subtle`, `bold` | `string`  | `neutral` | No       |
