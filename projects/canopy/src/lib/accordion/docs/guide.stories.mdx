...
<Meta title="Components/Accordion/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
@NgModule({
  ...
  imports: [ ..., LgAccordionComponent, LgAccordionItemComponent, LgAccordionPanelHeadingComponent ],
});
```
