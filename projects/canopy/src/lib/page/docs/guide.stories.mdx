...
<Meta title="Templates/Page/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
The page component works best when combined with the [grid module](./?path=/docs/directives-grid--grid) which can be used to provide a responsive layout for the main content.

Import the page and grid modules in your module:
