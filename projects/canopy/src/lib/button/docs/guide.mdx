...
|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|----------------|----------|
| `variant`      | The variant of button: `primary`,`secondary`, `link`, `add-on`.                                   | `string`                  | `primary` | No       |
...
```html
<button lg-button lgButtonToggle type="button" variant="primary">Button</button>
```
