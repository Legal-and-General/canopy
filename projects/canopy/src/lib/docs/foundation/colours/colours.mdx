...
{/* <Story id="internal-colours--core-colours" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="internal-colours--core-colours" />
...
{/* <Story id="internal-colours--secondary-colours" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="internal-colours--secondary-colours" />

### Tints

For digital use only, we have also created a range of tints to be used within our UI elements.

{/* <Story id="internal-colours--tints-colours" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="internal-colours--tints-colours" />
...
{/* <Story id="internal-colours--greyscale-colours" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="internal-colours--greyscale-colours" />
