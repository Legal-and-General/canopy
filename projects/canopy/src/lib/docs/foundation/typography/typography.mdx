...
{/* <Story id="internal-typography--productive" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="internal-typography--productive" />
...
{/* <Story id="internal-typography--expressive" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

<Story id="internal-typography--expressive" />
