...
<Meta title="Foundation/Typography" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
- **Do** check colour contrast of text on backgrounds (see [Colours](./?path=/docs/foundation-colours--page))
