...
<Meta title="Principles/Writing" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
To achieve this, we must be clear and consistent in the way we communicate. That's why we've created these guidelines. They're for anyone who has to write for Legal & General, whether that's for an internal or external audience.
