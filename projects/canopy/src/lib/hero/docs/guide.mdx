...
<Meta title="Patterns/Hero/Guide" tags={['pending']} />
...
Using the `LgHeroCardHeaderComponent` together with `LgBreadcrumbComponent`, breadcrumbs can be easily added to the hero. See the [breadcrumb component](./?path=/docs/components-breadcrumb-guide--docs).
          ...
          <lg-hero-card>
            <lg-hero-card-header>
              ...
              <lg-hero-card-notification>
                ...
                <p>
                  Your payments have been suspended, please <a href="#">contact us</a> to
                  learn more.
                </p>
              </lg-hero-card-notification>
            ...
            <lg-hero-card-content>
              <lg-hero-card-data-point-list>
                ...
                <lg-hero-card-data-point>
                  ...
                  <lg-hero-card-data-point-value> Monthly </lg-hero-card-data-point-value>
                </lg-hero-card-data-point>
                <lg-hero-card-data-point>
                  <lg-hero-card-data-point-label [headingLevel]="6">
                    Tax code
            ...
            <lg-hero-card-footer>
              <small class="lg-font-size-0-6"
                >* This is not a guaranteed amount and could be subject to change.</small
              >
            </lg-hero-card-footer>
          </lg-hero-card>
        </div>
