...
<Meta title="Patterns/Hero/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
Import the hero module in your module:
...
This is the top section of the hero bar, it stretches the full width and is agnostic of grid system. It is generally used to home the breadcrumb component if there is one. Similar to `LgHeroContentComponent` you will need to configure the grid in the contents of this component to match your page layout.
