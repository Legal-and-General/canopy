...
<span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '0.25rem' }}>
  ...
  />
  <span class="small-text">for brand modernisation in Canopy {' '} <a href="https://github.com/Legal-and-General/canopy/releases/tag/v41.0.0" target="_blank" rel="noopener noreferrer">v41</a>.</span>
</span>
...
<table lg-table>
  ...
  <tbody lg-table-body>
    ...
    <tr lg-table-row [isHidden]="<logic-to-handle-row>">
      <td lg-table-cell>
        <lg-table-expanded-detail> Detail content goes here </lg-table-expanded-detail>
      </td>
    </tr>
  </tbody>
</table>
    ...
    <tr lg-table-row>
      ...
      <td lg-table-cell [showLabel]="false" [stack]="true">
        ...
        <button lg-button type="button" priority="link">
          <lg-icon name="information-filled" />Find out more
        </button>
      </td>
    </tr>
  </tbody>
