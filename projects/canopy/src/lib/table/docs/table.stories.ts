...
const argTypes = {
  ...
  alignAuthorColumn: {
    options: [ AlignmentOptions.Start, AlignmentOptions.Centre, AlignmentOptions.End ],
    description: 'Align Author column.',
    table: {
      category: alignmentCategory,
      type: {
        summary: [ AlignmentOptions.Start, AlignmentOptions.Centre, AlignmentOptions.End ],
...
<table
  ...
  [variant]="variant">
      <thead lg-table-head>
        <tr lg-table-row>
          <th lg-table-head-cell [align]="alignAuthorColumn" [showLabel]="showAuthorLabel">
            Author
          </th>
      ...
      <tbody lg-table-body>
        @for (book of books; track book.title) {
          <tr lg-table-row>
            <td lg-table-cell [align]="alignAuthorColumn" [stack]="stack">
              {{ book.author }}
            </td>
...
export const StandardTable = {
  ...
  args: {
    ...
    variant: 'striped',
    alignAuthorColumn: AlignmentOptions.Start,
