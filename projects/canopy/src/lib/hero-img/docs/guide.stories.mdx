...
<Meta title="Patterns/Hero image/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
Import the hero image module in your module:
...
<Source id="patterns-hero-image-examples--hero-img"></Source>
