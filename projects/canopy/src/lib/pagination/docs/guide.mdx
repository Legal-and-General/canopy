...
|-------|-------------|------|---------|----------|
| `id` | HTML `id` attribute. If omitted, a unique id is generated automatically. | `string` | `lg-pagination-[nextUniqueId]` | No |
...
The accessible label on the `<nav>` element updates to announce the current visible range.
