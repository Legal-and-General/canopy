...
const template = `
<button lgModalTrigger="modal-story" lg-button type="button" priority="secondary">Open modal</button>
<lg-modal id="modal-story" closeOnOverlayClick="closeOnOverlayClick">
  ...
  <lg-modal-footer>
    <lg-button-group>
      <button lg-button lgMarginBottom="none" priority="primary" type="button">Button</button>
      <button lg-button lgMarginBottom="none" priority="secondary" type="button">Close</button>
    </lg-button-group>
  </lg-modal-footer>
</lg-modal>
`;
