...
<Meta title="Components/Modal/Guide" parameters={{ viewMode: 'docs', previewTabs: { canvas: { hidden: true } } }} />
...
Import the modal module in your module:
...
- [Message with illustration](./?path=/docs/components-primary-message--standard-primary-message)
